...
if __name__ == '__main__':
    ...
    # username = "apikey"
    # password = "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"
    # service = "sendgrid"
    # send_email_from_df(username,password,username,to,"test","../README.md","sendgrid")
